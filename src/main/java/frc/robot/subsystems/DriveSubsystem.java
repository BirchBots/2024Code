...
public class DriveSubsystem extends SubsystemBase {
  private final SwerveModule m_frontLeft = 
      new SwerveModule(kFlDriveCAN, kFlTurnCAN, kFrontLeftChassisAngularOffset, kFlEncoderId);

  private final SwerveModule m_frontRight =
      new SwerveModule(kFrDriveCAN, kFrTurnCAN, kFrontRightChassisAngularOffset, kFrEncoderId);

  private final SwerveModule m_rearLeft =
      new SwerveModule(kBlDriveCAN, kBlTurnCAN, kBackLeftChassisAngularOffset, kBlEncoderId);

  private final SwerveModule m_rearRight =
      new SwerveModule(kBrDriveCAN, kBrTurnCAN, kBackRightChassisAngularOffset, kBrEncoderId);
  ...
  public void drive(
    ...
    SmartDashboard.putNumber("flspd", swerveModuleStates[0].speedMetersPerSecond);
  }
